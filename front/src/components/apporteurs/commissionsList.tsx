...
const commissions = [
  { client: 'Seb', product: 'Actifry Simple One', date: '30/09/2024', commission: '25 €', isPaid: false },
  { client: 'Xerox', product: 'Imprimante Xerox 120', date: '30/09/2024', commission: '120 €', isPaid: false },
  { client: 'Samsung', product: 'Télévision 55"', date: '29/09/2024', commission: '750 €', isPaid: false },
  { client: 'Apple', product: 'iPhone 14', date: '28/09/2024', commission: '999 €', isPaid: false },
  { client: 'Sony', product: 'Casque Audio WH-1000XM4', date: '27/09/2024', commission: '350 €', isPaid: false },
  ...
  { client: 'Microsoft', product: 'Surface Pro', date: '23/09/2024', commission: '1200 €', isPaid: true },
  { client: 'LG', product: 'Réfrigérateur Smart', date: '22/09/2024', commission: '1500 €', isPaid: true },
  { client: 'Nikon', product: 'Appareil Photo DSLR', date: '21/09/2024', commission: '600 €', isPaid: true },
  { client: 'GoPro', product: 'Caméra HERO9', date: '20/09/2024', commission: '450 €', isPaid: true },
  { client: 'Lenovo', product: 'Tablette Yoga', date: '19/09/2024', commission: '300 €', isPaid: true },
  { client: 'Asus', product: 'Ordinateur Portable ROG', date: '18/09/2024', commission: '1200 €', isPaid: true },
  { client: 'Amazon', product: 'Echo Dot', date: '17/09/2024', commission: '50 €', isPaid: true },
